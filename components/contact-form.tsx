  ...
  if (isSubmitted) {
    return (
      <div className="flex flex-col items-center justify-center py-10 text-center">
        ...
        <p className="text-gray-600 mb-6">Vaša správa bola úspešne odoslaná. Čoskoro sa vám ozveme.</p>
            ...
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="plumbing">Inštalatérske práce</SelectItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Popíšte váš projekt alebo otázku..." className="min-h-[120px]" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
